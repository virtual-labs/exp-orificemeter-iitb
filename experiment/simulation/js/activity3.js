...
function start_act3() {
    ...
    <div class='collapse divide' style='style='margin-top: 2vw; 'width: 80%; margin: auto;' id='tb3-box'>
        ...
        <h5>A horizontal orificemeter inlet & orifice diameter are ${d1} cm and ${d2} cm respectively. The manometric fluid is mercury. Water is flowing through pipe. </h5>
        ...
        <div id='a3-2' style='display: none;'>
            ...
            <h5>Following reading of diffenctial manometric head were taken by varying find the coefficient of discharge of orificemeter.</h5>
...
function internal_calculations3() {
    ...
    let temp_hm = 20;
    for (let i = 0; i < 9; i++) {
        let cd = parseFloat((Math.random() * 0.04 + 0.9).toFixed(2));
