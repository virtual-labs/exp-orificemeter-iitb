...
function activity1() {
    ...
    <div style='margin-top: 2vw;'>
        ...
        <div class="fs-16px">
        <h5>Flow Through Orificemeter</h5>
...
function start_act1() {
    ...
    <div class='collapse divide' style='style='margin-top: 2vw; 'width: 80%; margin: auto;' id='tb1-box'>
        ...
        <h5>A horizontal orificemeter inlet & orifice diameter are ${d1} cm and ${d2} cm respectively. The hm = ${hm} cm. The manometer fluid is mercury. Take c<sub>d</sub> = 0.94. water is flowing through pipe find discharge.</h5>

        <br>

        <div style='text-align: center;'><img style='width: 50%;' src='./images/ori1.png'></div>
